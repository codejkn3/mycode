...
def get_ip_data():
    ...
    input_speed = str(input("What is the speed in MBps? "))
    input_hostname = input("What is the hostname? ")
    d = {"IP": input_ip, "driver": input_driver, "Speed":input_speed, "Hostname":input_hostname}
    return d
...
try:
    ...
    print("Error {err} while saving the Excel file\n")
